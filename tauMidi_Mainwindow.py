...
#
# Created: Thu Dec  4 14:10:27 2014
...
class Ui_tauMidiGenerator_Mainwindow(object):
    def setupUi(self, tauMidiGenerator_Mainwindow):
        ...
        tauMidiGenerator_Mainwindow.resize(681, 401)
        ...
        tauMidiGenerator_Mainwindow.setMinimumSize(QtCore.QSize(650, 401))
        tauMidiGenerator_Mainwindow.setMaximumSize(QtCore.QSize(700, 401))
        icon = QtGui.QIcon()
        ...
        self.notesAtributes_groupbox.setGeometry(QtCore.QRect(280, 150, 391, 141))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.time_textfield.sizePolicy().hasHeightForWidth())
        self.time_textfield.setSizePolicy(sizePolicy)
        ...
        self.pitch_button = QtWidgets.QPushButton(self.notesAtributes_groupbox)
        self.pitch_button.setGeometry(QtCore.QRect(300, 20, 75, 23))
        self.pitch_button.setObjectName("pitch_button")
        self.time_button = QtWidgets.QPushButton(self.notesAtributes_groupbox)
        self.time_button.setGeometry(QtCore.QRect(300, 50, 75, 23))
        self.time_button.setObjectName("time_button")
        self.duration_button = QtWidgets.QPushButton(self.notesAtributes_groupbox)
        self.duration_button.setGeometry(QtCore.QRect(300, 80, 75, 23))
        self.duration_button.setObjectName("duration_button")
        self.volume_button = QtWidgets.QPushButton(self.notesAtributes_groupbox)
        self.volume_button.setGeometry(QtCore.QRect(300, 110, 75, 23))
        ...
        self.imagen.setGeometry(QtCore.QRect(560, 20, 101, 111))
        self.imagen.setText("")
        self.imagen.setPixmap(QtGui.QPixmap(":/Iconos/ListTrackIco.png"))
        ...
        self.menu.setGeometry(QtCore.QRect(0, 0, 681, 21))
    ...
    def retranslateUi(self, tauMidiGenerator_Mainwindow):
        ...
        self.pitch_button.setText(_translate("tauMidiGenerator_Mainwindow", "Auto Pitch"))
        self.time_button.setText(_translate("tauMidiGenerator_Mainwindow", "Auto Time"))
        self.duration_button.setText(_translate("tauMidiGenerator_Mainwindow", "Auto Duration"))
        self.volume_button.setText(_translate("tauMidiGenerator_Mainwindow", "Auto Volume"))
